...
addButton.on("click", function() {
   ...
   newRow.find("td:nth-of-type(1) input").prop("name", "Articles[" + (currentCount - 1) + "].Name");
   newRow.find("td:nth-of-type(2) input").prop("name", "Articles[" + (currentCount - 1) + "].Size");
   newRow.find("td:nth-of-type(3) input").prop("name", "Articles[" + (currentCount - 1) + "].Price");
   
   $("table tbody").append(newRow);
   newRow.find("td:nth-of-type(1) input").focus();
});
